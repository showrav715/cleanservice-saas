...
trait Paytm {
    ...
    public function getPaymentData($res){
        if($res == 'admin'){
	...
	public function handlePaytmRequest( $order_id, $amount, $type,$res ) {
            $paydata = $this->getPaymentData($res);
            ...
            if($type == 'checkout'){
                $paramList["CALLBACK_URL"] = route('seller.front.paytm.notify');
            }else if($type == 'package'){
                $paramList["CALLBACK_URL"] = route('seller.paytm.notify');
            
            }else if($type == 'landing'){
                $paramList["CALLBACK_URL"] = route('landing.paytm.notify');
            }
