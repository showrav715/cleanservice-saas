...
@section('breadcrumb')
 <section class="section">
    <div class="section-header d-flex justify-content-between">
        ...
        <a href="{{route('seller.page.create')}}" class="btn btn-primary"><i class="fas fa-plus"></i> @lang('Create New') </a>
    </div>
</section>
@endsection
                ...
                @forelse ($pages as $info)
                    <tr>
                         ...
                         <td data-label="@lang('Actions')">
                            <a href="{{route('seller.page.edit',$info)}}" class="btn btn-primary btn-sm mb-1"  data-toggle="tooltip" title="@lang('Edit')"><i class="fas fa-edit"></i></a>
...
<div class="modal fade" id="removeMod" tabindex="-1" role="dialog">
   <div class="modal-dialog" role="document">
      <form action="{{route('seller.page.remove')}}" method="POST">
         @csrf
