   ...
   <div class="col-md-12">
      ...
      <div class="card mb-4">
         ...
         <div class="card-body">
            ...
            <form action="{{route('seller.slider.store')}}" enctype="multipart/form-data" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="subtitle" id="subtitle" required placeholder="{{ __('Subtitle') }}" value="{{old('subtitle')}}">
                </div>
                <div class="form-group">
                    <label for="text">{{ __('Text') }} *</label>
                    <textarea name="text" class="form-control" id="text"rows="4" placeholder="Enter Sort Text"></textarea>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="btn1_text" id="btn1_text" placeholder="{{ __('Button 1 Text') }}" value="{{old('btn1_text')}}">
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12 col-md-6">
                        <div class="form-group">
                            <label for="btn1_link">{{ __('Button 1 Link') }}</label>
                            <input type="text" class="form-control" name="btn1_link" id="btn1_link" placeholder="{{ __('Button 1 Link') }}" value="{{old('btn1_link')}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="btn2_text" id="btn2_text" placeholder="{{ __('Button 2 Text') }}" value="{{old('btn2_text')}}">
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12 col-md-6">
                        <div class="form-group">
                            <label for="btn2_link">{{ __('Button 2 Link') }}</label>
                            <input type="text" class="form-control" name="btn2_link" id="btn2_link" placeholder="{{ __('Button 2 Link') }}" value="{{old('btn2_link')}}">
                        </div>
                    </div>
                </div>
