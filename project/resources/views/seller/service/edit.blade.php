        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('seller.service.update', $service->id) }}" enctype="multipart/form-data"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                                ...
                                <div class="form-group d-flex justify-content-center">
                                    <div id="image-preview" class="image-preview image-preview_alt"
                                        style="background-image:url({{ showPhoto($service->feature_icon) }});">
                                        <label for="image-upload" id="image-label">@lang('Choose File')</label>
                                        <input type="file" name="feature_icon" id="image-upload" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                                ...
                                <div class="form-group d-flex justify-content-center">
                                    <div id="image-preview_t" class="image-preview image-preview_alt"
                                        style="background-image:url({{ showPhoto($service->photo) }});">
                                        <label for="image-upload_t" id="image-label">@lang('Choose File')</label>
                                        <input type="file" name="photo" id="image-upload_t" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="area1" class="form-control" name="sort_text" placeholder="{{ __('Sort Text') }}" required>{{ old('sort_text', $service->sort_text) }}</textarea>
                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                                ...
                                <div class="form-group d-flex justify-content-center">
                                    <div id="image-preview_c" class="image-preview image-preview_alt"
                                        style="background-image:url({{ showPhoto($service->service_quality_photo) }});">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                                ...
                                <div class="form-group d-flex justify-content-center">
                                    <div id="image-preview_d" class="image-preview image-preview_alt"
                                        style="background-image:url({{ showPhoto($service->service_quality_before_photo) }});">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="area1" class="form-control" name="service_quality_text"
                                placeholder="{{ __('Service Quality Text') }}" required>{{ old('service_quality_text', $service->service_quality_text) }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>{{ __('Feature') }}</label>
                            <select class="form-control  mb-3" name="is_feature">
                                <option value="1" {{ $service->is_feature == 1 ? 'selected' : '' }}>
                                    {{ __('Yes') }}</option>
                                <option value="0" {{ $service->is_feature == 0 ? 'selected' : '' }}>
                                    {{ __('No') }}</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control  mb-3" name="status" required>
                                ...
                                <option value="0" {{ $service->status == 0 ? 'selected' : '' }}>{{ __('Inactive') }}
                                </option>
                            </select>
                        </div>
