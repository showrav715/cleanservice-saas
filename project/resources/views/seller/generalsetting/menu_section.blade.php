...
<div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                   <ul class="list-group">
                      ...
                      <li class="list-group-item d-flex justify-content-between">
                         ...
                         <a data-title="{{ ('About') }}" data-dropdown="yes" data-href="/about"  data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                      </li>
                      <li class="list-group-item d-flex justify-content-between">
                         <span class="menu-items">{{ ('API') }}</span>
                         <a data-title="{{ ('API') }}" data-dropdown="yes" data-href="/api-documentation"  data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                      </li>
                      <li class="list-group-item d-flex justify-content-between">
                         <span class="menu-items">{{ ('Blogs') }}</span>
                         <a data-title="{{ ('Blogs') }}" data-dropdown="yes" data-href="/blogs"  data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                      </li>
                      <li class="list-group-item d-flex justify-content-between">
                         <span class="menu-items">{{ ('Contact') }}</span>
                         <a data-title="{{ ('Contact') }}" data-dropdown="yes" data-href="/contact"  data-target="self" class="btn btn-primary btn-sm btn-rounded addToMenu" href="javascript:;">{{ __('Add To Menu') }}</a>
                      </li>
          ...
          <div class="card-body">
             ...
             <div class="form-group">
                ...
                <select class="form-control" id="target">
                   ...
                   <option value="blank">@lang('New Tab')</option>
                </select>
             </div>
             <div class="form-group">
    ...
    <div class="col-md-6 col-xl-4">
       <div class="card mb-4">
          ...
          <div class="card-body">
             <form class="admin-form" id="" action="{{ route('seller.gs.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @include('seller.partials.form-both')
