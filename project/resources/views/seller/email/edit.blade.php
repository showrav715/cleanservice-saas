...
@section('breadcrumb')
 <section class="section">
    <div class="section-header justify-content-between">
        ...
        <a class="btn btn-primary" href="{{route('admin.mail.index')}}"><i class="fas fa-backward"></i> @lang('Back')</a>
    </div>
</section>
@endsection
    ...
    <div class="col-lg-10">
       <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
             <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit Email Template Form') }}</h6>
          </div>
          <div class="card-body">
           ...
           <form id="geniusformUpdate" action="{{route('admin.mail.update',$data->id)}}" method="POST" enctype="multipart/form-data">
              @csrf
             ...
             <div class="row justify-content-center mb-3" >
                ...
                <div class="form-group">
                   ...
                   <textarea id="area1" class="form-control summernote" name="email_body" placeholder="{{ __('Email Body') }}">{{$data->email_body}}</textarea>
                </div>
                <div class="row">
                   <div class="col-lg-4">
                      <div class="left-area">
