 ...
 <section class="section">
    <div class="section-header justify-content-between">
        <h1> @lang('Manage Staff')</h1>
            ...
            <a href="javascript:void(0)" data-toggle="modal" data-target="#addModal" class="btn btn-primary btn-sm add"><i class="fas fa-plus"></i> @lang('Add New Staff')</a>
                        ...
                        @forelse ($staffs as $key => $user)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    <a class="btn btn-primary btn-sm details" data-staff="{{$user}}" href="javascript:void(0)" data-route="{{route('admin.staff.update',$user->id)}}">@lang('Details')</a>
