...
@section('breadcrumb')
 <section class="section">
    <div class="section-header  d-flex justify-content-between">
        ...
        <a href="{{route('seller.blog.index')}}" class="btn btn-primary"><i class="fas fa-backward"></i> @lang('Back')</a>
    </div>
</section>
@endsection
@section('content')
   ...
   <div class="col-md-12">
      ...
      <div class="card mb-4">
         ...
         <div class="card-body">
            ...
            <form action="{{route('seller.blog.update',$blog->id)}}" enctype="multipart/form-data" method="POST">
                @csrf
                @method('PUT')
                <div class="col-md-12 ShowImage mb-3  text-center">
                    <img src="{{ showPhoto($blog->photo) }}" class="img-fluid" alt="image" width="400">
                 </div>
