    ...
    <div class="col-lg-12">
       <div class="card mb-4">
          ...
          <div class="card-body">
             ...
             <form action="{{route('admin.group.submit')}}" enctype="multipart/form-data" method="POST" id="geniusformUpdate">
                 @csrf
                 ...
                 <div class="row">
                     <div class="col-md-12">
                         <div class="form-group">
                             ...
                             <select class="form-control  mb-3" id="type" name="type">
                                 ...
                                 <option value="user">{{translate('All User')}}</option>
                                 <option value="subscriber">{{translate('Subscribers')}}</option>
                     ...
                     <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="body" class="form-control nic-edit" name="message" rows="5" placeholder="{{ __('Description') }}"></textarea>
                        </div>
                    </div>
