                   ...
                   <div class="card-body">
                    <div class="chatbox__list__wrapper">
                        <div class="d-flex flex-wrap justify-content-between mb-3 pb-3 border-bottom border--dark">
                            <h5 class="my-2"><a href="javascript:void(0)">@lang('Tickets')<i class="fas fa-arrow-right"></i></a></h5>
                            <form action="" class="my-2">
                                <div class="form-group mb-0">
                                    <div class="input-group">
                                        <input class="form-control" name="search" value="{{$search}}" type="text" placeholder="@lang('Search Ticket')">
                                                                ...
                                                                <div class="post__creator-content">
                                                                    ...
                                                                    @if ($item->file)
                                                                        <div class="text-start">
                                                                            <a href="{{getFile($item->file,$item->user_id)}}" download="">{{$item->file}}</a>
                                                                        </div>
                                                                      @endif
