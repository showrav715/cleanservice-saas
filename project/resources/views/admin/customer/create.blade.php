      ...
      <div class="card mb-4">
         <div class="card-body">
            ...
            <form action="{{route('admin.customer.store')}}" method="post">
               ...
               <div class="form-group row mb-4">
                  <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Domain Name  <br><small class="text-danger">only set your main domain</small></label>
                  <div class="col-sm-12 col-md-7">
                     <input type="text" class="form-control" name="domain_name" value="{{old('domain_name')}}">
                     <code>if is domain https://example.com or https://www.example.com you will used only example.com </code>
                  </div>
               </div>
               <div class="form-group row mb-4">
