                            ...
                            <tr>
                                ...
                                @endphp
                                    <a href="{{ $customer_domain ?? '' }}"
                                        target="_blank">{{ $customer_domain ?? '' }}</a>
                                </td>
                                ...
                                <td data-label="@lang('Actions')" class="customer">
                                    <div class="dropdown d-inline ">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item has-icon sendMail" href="javascript:;"
                                                data-route="{{ route('admin.customer.send.mail', $seller->id) }}"
                                                data-item="{{ $seller }}" data-toggle="tooltip"
                                            ...
                                            <a class="dropdown-item has-icon remove"  data-id="{{ $seller->id }}" data-toggle="tooltip"><i
