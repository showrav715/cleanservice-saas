        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card profile-widget">
                <div class="profile-widget-header">
                    <img alt="image" src="{{ getPhoto($user->photo,$user->name) }}" class="profile-widget-picture">
                        ...
                        <div class="col-lg-3 col-sm-12 mt-2">
                            <div class="list-group" id="list-tab" role="tablist">
                                ...
                                <a class="list-group-item list-group-item-action " id="customer-list" data-toggle="list"
                                    href="#customer" role="tab" aria-selected="true"><b>@lang('Customers')</b></a>
                                        ...
                                        <table class="table table-hover" id="table">
                                            ...
                                            <tbody>
                                                @foreach ($customers as $customer)
                                                    <tr>
                                                        <th data-label="Name">{{ $customer->name }}</th>
                                                        <td data-label="Email">{{ $customer->email }}</td>
                                                        <td data-label="Phone">{{ $customer->phone }}</td>
                                                        <td data-label="Created at">{{ dateFormat($customer->created_at) }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                            ...
                                            <tbody>
                                                @foreach ($package_histories as $item)
                                                    <tr>
                                                        ...
                                                        <td data-label="Price">{{ adminShowAmount($item->amount) }}</td>
