               ...
               @forelse ($categories as $item)
                   <tr>
                        ...
                        <td data-label="@lang('Action')" class="text-right">
                           <a href="{{route('admin.childcategory.index',$item->id)}}" class="btn btn-primary btn-sm mb-1"  title="@lang('Manage Child')"><i class="fas fa-list"></i> @lang('Manage Subcategory')</a>
