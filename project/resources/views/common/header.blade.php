            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="header-top-left">
                        <span><i class="fas fa-fire-alt"></i> {{ $gs->header_text }}</span>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="header-top-right">
                        <span><i class="far fa-clock"></i> {{ $gs->working_hour }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-3">
                    <div class="logo">
                        <a href="{{route('front.index')}}"><img src="{{ showPhoto($gs->header_logo) }}" alt="Logo"></a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="contact-info-item">
                                    ...
                                    <div class="content">
                                        <h4 class="title">@lang('Mail To Us')</h4>
                            ...
                            <div class="col-md-4">
                                <div class="contact-info-item">
                                    ...
                                    <div class="content">
                                        <h4 class="title">@lang('Call for help'):</h4>
                    ...
                    <div class="menu-wrap">
                        <nav class="menu-nav">
                            <div class="logo d-none">
                                <a href="{{ route('front.index') }}"><img src="{{ showPhoto($gs->header_logo) }}"
                                        alt="Logo"></a>
                            </div>
                            <div class="navbar-wrap main-menu d-none d-lg-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="menu-item-has-children"><a href="#">@lang('Pages')</a>
                                        <ul class="sub-menu">
                                            @foreach (App\Models\UserPage::get() as $page)
                                                <li><a
                                                        href="{{ route('front.page', $page->slug) }}">{{ $page->title }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </li>
                            ...
                            <div class="header-action d-none d-md-block">
                                <ul class="list-wrap">
                                    <li class="header-search"><a href="#"><i class="fas fa-search"></i></a>
                                    </li>
                                    <li class="header-btn"><a href="{{ route('front.getintuch') }}"
                                            class="btn">@lang('Get in Touch')</a>
                                    </li>
    ...
    <div class="search-popup-wrap" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="search-wrap text-center">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="title">... @lang('Search Here') ...</h2>
                        <div class="search-form">
                            <form action="{{ route('front.service') }}">
                                <input type="text" name="search"
                                    placeholder="{{ __('Type Service keywords here') }}">
