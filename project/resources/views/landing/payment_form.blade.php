    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="card" placeholder="@lang('Enter Card Number')">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label>@lang('Month')</label>
                <input class="form-control" type="text" name="month" placeholder="@lang('Month')">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label>@lang('Year')</label>
                <input class="form-control" type="text" name="year" placeholder="@lang('Year')">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label>@lang('CVC')</label>
                <input class="form-control" type="text" name="cvc" placeholder="@lang('Enter CVC')">
            </div>
        </div>
    </div>
@endif
