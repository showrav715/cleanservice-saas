		...
		ve = (function () {
			...
			return (
					...
					if (this._isBodyOverflowing) {
						...
						g(t).each(function (t, e) {
							var n = e.style.paddingRight,
								i = g(e).css("padding-inline-end");
							g(e)
								.data("padding-inline-end", n)
								.css(
									"padding-inline-end",
							...
							g(e).each(function (t, e) {
								var n = e.style.marginRight,
									i = g(e).css("margin-inline-end");
								g(e)
									.data("margin-inline-end", n)
									.css(
										"margin-inline-end",
										parseFloat(i) - o._scrollbarWidth + "px"
									);
						...
						var n = document.body.style.paddingRight,
							i = g(document.body).css("padding-inline-end");
						g(document.body)
							.data("padding-inline-end", n)
							.css(
								"padding-inline-end",
				...
				(t._resetScrollbar = function () {
					var t = [].slice.call(document.querySelectorAll(me));
					g(t).each(function (t, e) {
						var n = g(e).data("padding-inline-end");
						g(e).removeData("padding-inline-end"),
							(e.style.paddingRight = n || "");
					});
					var e = [].slice.call(document.querySelectorAll("" + pe));
					g(e).each(function (t, e) {
						var n = g(e).data("margin-inline-end");
						"undefined" != typeof n &&
							g(e)
								.css("margin-inline-end", n)
								.removeData("margin-inline-end");
					});
					var n = g(document.body).data("padding-inline-end");
					g(document.body).removeData("padding-inline-end"),
		...
		ni = (function () {
			...
			return (
				...
				(t._close = function () {
					...
					if (
						(this._element.classList.remove(Gn), this._config.animation)
					) {
						var n = _.getTransitionDurationFromElement(this._element);
						g(this._element)
							.one(_.TRANSITION_END, e)
