			...
			var h = /Edge\/\d+/.test(c),
				...
				m = {
					...
					isFontInstalled: function (t) {
						var e =
								"Comic Sans MS" === t ? "Courier New" : "Comic Sans MS",
						...
						n = (n = n.replace(
							...
							function (t, e, n) {
								...
								var o = /^DIV|^TD|^TH|^P|^LI|^H[1-7]/.test(n) && !!e,
									i = /^BLOCKQUOTE|^TABLE|^TBODY|^TR|^HR|^UL|^OL/.test(
										n
									);
								return t + (o || i ? "\n" : "");
							}
						...
						},
						{
							...
							value: function (t, e) {
								...
								return function (o) {
									...
									n.invoke(
										t,
										e || r.closest("[data-value]").data("value"),
										r
									);
								};
							},
			...
			i.a.fn.extend({
				summernote: function () {
					...
					(o.langInfo = i.a.extend(
						...
						(o.tooltip =
							"auto" === o.tooltip ? !m.isSupportTouch : o.tooltip),
							...
							},
							{
								...
								value: function (e) {
									var n = this.getEndPoint(),
										o = function (t) {
											return (
												!pt.isCharPoint(t) && !pt.isSpacePoint(t)
											);
										};
									if (o(n)) return this;
						...
						},
						{
							...
							value: function (t) {
								null !== t.contents && this.$editable.html(t.contents),
									null !== t.bookmark &&
										wt
											.createFromBookmark(this.editable, t.bookmark)
											.select();
							},
						},
						{
					...
					(n = [
						...
						},
						{
							...
							value: function (t) {
								...
								return (
									(n.anchor =
										t.isOnAnchor() && pt.ancestor(t.sc, pt.isAnchor)),
						...
						},
						{
							...
							value: function (t, e) {
								var n = C.head(t),
									o = C.last(t),
									i =
										pt.isList(n.previousSibling) && n.previousSibling,
							...
							value: function (t, e) {
								...
								if (o) {
									...
									if (
										...
										(s = s.concat(
											pt.listDescendant(n, pt.isEmptyAnchor)
										)),
					...
					(n = [
									...
									this.options.airMode
										? this.options.overrideContextMenu &&
										  this.$editor.on("contextmenu", function (e) {
												return (
													t.context.triggerEvent("contextmenu", e),
													!1
												);
										  })
										: (this.options.width &&
								...
								return (
									...
									(void 0 === e ||
										!(
											...
											e.metaKey ||
											C.contains(
												[xt.code.BACKSPACE, xt.code.DELETE],
												e.keyCode
											)
										)) &&
						...
						},
						{
							...
							value: function () {
								...
								return (
									e.length &&
										(n.isNewWindow = "_blank" === e.attr("target")),
									n
								);
							},
						},
						...
						},
						{
							...
							value: function (t) {
								...
								if (n && n.items && n.items.length) {
									var o =
										n.items.length > 1 ? n.items[1] : C.head(n.items);
					...
					(n = [
						...
						},
						{
							...
							value: function (t, e) {
								...
								if (
									(this.context.invoke("imagePopover.update", t, e), n)
								) {
									var r = i()(t),
										a = r.position(),
										s = {
												...
												click: function (t) {
													...
													n && o
														? r.context.invoke("editor.color", {
																backColor:
																	e.attr("data-backColor"),
																foreColor:
																	e.attr("data-foreColor"),
														  })
														: n
														? r.context.invoke("editor.color", {
																backColor:
								...
								return i.a
									.Deferred(function (n) {
										...
										e.ui.onDialogShown(e.$dialog, function () {
											...
											a.prop("checked", l);
											var c =
												!t.url && e.context.options.useProtocol;
											s.prop("checked", c),
					...
					(n = [
						...
						},
						{
							...
							value: function (t) {
								...
								return (
									"string" == typeof o && (o = pt.createText(o)), o
								);
							},
						},
						{
							...
							value: function (t, e) {
								...
								return (
									this.searchKeyword(t, e, function (e) {
										(e = e || []).length &&
											(o.html(n.createItemTemplates(t, e)),
											n.show());
									}),
									o
								);
									...
									if ("words" === this.options.hintMode) {
										if (
											...
											this.hints.forEach(function (t) {
												if (t.match.test(o))
													return (
														(n = r.getWordsMatchRange(t.match)),
														!1
													);
											}),
											!n)
