		...
		b = function (e, p) {
					...
					if (T.ishwscroll)
						...
						if (
							((o = {
								top: r.top,
								left:
									r.left - (M.railpadding.left + M.railpadding.right),
							}),
							(o.top += x(T.win, "border-top-width", !0)),
							(o.left += T.rail.align
								? T.win.outerWidth() -
								  x(T.win, "border-inline-end-width") -
								  T.rail.width
								: x(T.win, "border-inline-start-width")),
							(t = M.railoffset) &&
								(t.top && (o.top += t.top),
							...
							var i = T.railh.align
									? o.top +
									  ...
									  T.railh.height
									: o.top + x(T.win, "border-top-width", !0),
								s = o.left + x(T.win, "border-inline-start-width");
							T.railh.css({
						...
						if (
							...
							if (T.ishwscroll) {
								...
								T.isfixed || (T.viewport = T.getViewport(T.win[0])),
									...
									T.railh &&
										(w.css({ position: S }), T.body.append(w));
							}
							P.isios &&
								T.css(T.win, {
											...
											T.synched("touchmove", function () {
												T.rail.drag &&
													...
													T.rail.drag.hr
														? T.doScrollLeft(
																Math.round(
																	T.scroll.x * T.scrollratio.x
																),
																M.cursordragspeed
														  )
														: T.doScrollTop(
																Math.round(
																	T.scroll.y * T.scrollratio.y
																),
																M.cursordragspeed
														  ));
											}),
							...
							(T.onmousemove = function (e) {
								if (T.rail.drag) {
									...
									if (
										...
										(T.scroll.x =
											T.rail.drag.sx + (e.clientX - T.rail.drag.x)),
											T.scroll.x < 0 && (T.scroll.x = 0);
										var o = T.scrollvaluemaxw;
										T.scroll.x > o && (T.scroll.x = o);
									} else {
										(T.scroll.y =
											T.rail.drag.sy + (e.clientY - T.rail.drag.y)),
											T.scroll.y < 0 && (T.scroll.y = 0);
										var t = T.scrollvaluemax;
										T.scroll.y > t && (T.scroll.y = t);
									}
						...
						T.railslocked
							...
							: (T.hidden ||
							  ...
							  T.getScrollTop() > T.page.maxh
									...
									: ((T.scroll.y =
											(T.getScrollTop() / T.scrollratio.y) | 0),
									  (T.scroll.x =
											(T.getScrollLeft() / T.scrollratio.x) | 0),
			...
			(this.delegate = function (e, o, t, r, i) {
				...
				(this.hideRail = function () {
					return (
						(T.rail.visibility = !1), T.rail.css("display", "none"), T
					);
				}),
							...
							if (
								...
								M.bouncescroll
									? (o < 0
											...
											: o > T.page.maxh &&
											  (o =
													(T.page.maxh + (o - T.page.maxh) / 2) |
													0),
									  e < 0
											? (e = (e / 2) | 0)
											: e > T.page.maxw &&
											  (e =
													(T.page.maxw + (e - T.page.maxw) / 2) |
													0))
									: (o < 0
											? (o = 0)
											: o > T.page.maxh && (o = T.page.maxh),
									  e < 0
											? (e = 0)
											: e > T.page.maxw && (e = T.page.maxw)),
								T.scrollrunning &&
									e == T.newscrollx &&
									o == T.newscrolly)
							)
					...
					(this.doScrollLeft = function (e, o) {
						...
						(this.doScrollPos = function (e, o, t) {
							...
							(T.newscrolly = o),
								...
								(T.dst.py = r);
							var n =
									0 | Math.sqrt(T.dst.x * T.dst.x + T.dst.y * T.dst.y),
					...
					if (c || d) {
						...
						var p = o.lastscrollx,
							...
							g = function () {
								...
								o.speedx &&
									((p = Math.floor(
										o.lastscrollx - o.speedx * (1 - o.demulxy)
									)),
									(o.lastscrollx = p),
									(p < 0 || p > l) && (e = 0.1)),
									o.speedy &&
