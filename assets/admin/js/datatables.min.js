...
!(function (n) {
			...
			for (a = 0, r = d.length; a < r; a++) {
				...
				for (o = 0, i = d[a].length; o < i; o++)
					if (((f = c = 1), h[a][o] === N)) {
						...
						for (
							;
							d[a][o + f] !== N && d[a][o].cell == d[a][o + f].cell;
	...
	function _t(t) {
		for (
			...
			e &&
				((l = t.aanFeatures)[n] || (l[n] = []), l[n].push(e), f.append(e));
		}
					...
					for (
						u =
							(u = +a.getAttribute("colspan")) && 0 != u && 1 != u
								...
								: 1,
							c =
								(c = +a.getAttribute("rowspan")) && 0 != c && 1 != c
									? c
									: 1,
							s = (function (t, e, n) {
								for (var a = t[e]; a[n]; ) n++;
